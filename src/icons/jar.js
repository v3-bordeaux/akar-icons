...
const Jar = ({ color = 'currentColor', size = '24', ...otherProps }) => {
  return (
    <svg
      ...
      {...otherProps}
    >
      <path d="M3 9l1.164 8.926a3.875 3.875 0 0 0 2.844 3.243c3.27.872 6.713.872 9.984 0a3.875 3.875 0 0 0 2.844-3.243L21 9"></path>
      ...
      <path d="M15 4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2"></path>
    </svg>
  );
};
